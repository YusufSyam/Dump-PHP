...
if(!isset($_SESSION["login"])) sessionStartedRedirect("Silahkan Login terlebih dahulu", "Login.php");

$arrDatabase= fetchQuery("SELECT * FROM ss_mahasiswa WHERE id_mahasiswa=".$_GET["xyz"])[0];
...
if(isset($_POST["submit"])){
	...
	errorCheck($database,"baris diubah");
}
